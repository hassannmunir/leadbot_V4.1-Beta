...
_REGIONS_MAP_PATH = Path(__file__).parent / "regions_map.json"
...
def load_regions_map() -> dict[str, list[str]]:
    """Load the console's country -> region dropdown data (see regions_map.json)."""
    return json.loads(_REGIONS_MAP_PATH.read_text(encoding="utf-8"))
